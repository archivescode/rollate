...
$.widget('javobyte.rouletteWheel', {
    ...
    _rotate: function () {
    	console.log(this._options.spinTime);
    	console.log(this._options.spinTimeTotal);
        ...
        var key = keys[index];
        if ( (this._options.spinTimeTotal - this._options.spinTime) <= 2000 ) {
        	if (this.options.mustSelected != key) {
        		this._options.spinTime -= 60;
        	} else {
        		if (this._options.spinTime >= 8000){
        			this.stop();
	            	return;
	        	}else{
